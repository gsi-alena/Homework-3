...
public class LoginStep {
	...
	public void the_system_displays_an_error_message(String stepmessage) {
		if(stepmessage.equals("This field is required"))
			loginPage.checkCredentials(stepmessage);
			else if(stepmessage.equals("Please, enter a valid email address.")) {
			loginPage.validateEmail(stepmessage);	
			}							
	}
	public void the_system_displays_an_error_message_in_popup_windows() {
